...
class RecipeController extends Controller
{
    public function edit(Product $product)
    {
        ...
        return view('seller.products.recipe', compact('product', 'ingredients'));
    }
    ...
    public function update(Request $request, Product $product)
    {
        ...
        $data = $request->validate([
            ...
            'ingredients.*.ingredient_product_id' => [
                'required',
                'integer',
                Rule::exists('products', 'id')->where(fn ($q) => $q->where('seller_id', Auth::id())),
            ],
        ...
        return redirect()
            ->route('seller.products.recipe.edit', $product)
