...
@section('breadcrumb')
<a href="{{ route('supplier.stocks.index') }}">Stock History</a>
...
<form action="{{ route('supplier.stocks.update') }}" method="POST">
    @csrf
    <div class="max-w-3xl">
        <div class="card">
            ...
            <div class="card-footer flex justify-end gap-2">
                <a href="{{ route('supplier.stocks.index') }}" class="btn btn-secondary">Cancel</a>
