...
<div class="page-header">
    <div>
        <p class="page-subtitle">Overview of your supply business performance</p>
    </div>
...
@php
$statCards = [
    ['title' => "Sales ({$totalOrders})", 'value' => money($totalSales), 'route' => route('supplier.invoices'), 'icon' => 'ri-receipt-2-line'],
    ['title' => 'Cash In Hand', 'value' => money($cashInHand), 'route' => route('supplier.invoices'), 'icon' => 'ri-wallet-3-line'],
    ['title' => 'Revenue', 'value' => money($totalRevenue), 'route' => route('supplier.invoices'), 'icon' => 'ri-money-dollar-circle-line'],
    ['title' => 'Due', 'value' => money($due), 'route' => route('supplier.invoices'), 'icon' => 'ri-error-warning-line'],
    ['title' => 'Products', 'value' => $totalProducts, 'route' => route('supplier.products.index'), 'icon' => 'ri-box-3-line'],
    ['title' => 'Customers', 'value' => $totalCustomers, 'route' => route('supplier.customers.index'), 'icon' => 'ri-team-line'],
];
@endphp
...
<div class="card mt-6">
    <div class="card-header">
        ...
        <a href="{{ route('supplier.invoices') }}" class="btn btn-sm btn-secondary">
            ...
            <tbody>
                @forelse($recentOrders as $order)
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{ route('supplier.sales.invoice', $order->order_id) }}" class="btn btn-primary btn-sm" title="Invoice" target="_blank">
