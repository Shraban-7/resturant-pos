...
<div class="page-header">
    ...
    <div class="page-actions">
        <a class="btn btn-primary" href="{{ route('supplier.products.create') }}">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="inline-flex items-center gap-1">
                                <a href="{{ route('supplier.products.edit', $product->id) }}" class="btn btn-primary btn-sm" title="Edit">
                                    <i class="ri-edit-box-line"></i>
                                </a>
                                <a href="{{ route('supplier.products.delete', $product->id) }}"
                ...
                @empty
                    <tr><td colspan="6">
                        <div class="empty-state">
                            ...
                            <a href="{{ route('supplier.products.create') }}" class="btn btn-primary mt-4">
                                <i class="ri-add-line"></i> Add Product
                            </a>
                        </div>
                    </td></tr>
