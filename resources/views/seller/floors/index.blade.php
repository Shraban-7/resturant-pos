                ...
                @forelse ($floors as $floor)
                    <tr>
                        ...
                        <td class="text-right space-x-1">
                            <a href="{{ route('seller.diningTables.floorMap', ['floor_id' => $floor->id]) }}" class="btn btn-secondary btn-sm">
                            ...
                            <form action="{{ route('seller.floors.destroy', $floor) }}" method="post" class="inline"
        ...
        <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display:none">
            ...
            <div class="modal-dialog modal-sm relative">
                <div class="modal-content">
                    ...
                    <form action="{{ route('seller.floors.store') }}" method="post">
                        @csrf
