...
@php
$statCards = [
    ['title' => "Sales ({$totalOrders})", 'value' => money($totalSales), 'route' => route('seller.sales.index'), 'icon' => 'ri-receipt-2-line'],
    ['title' => 'Cash In Hand', 'value' => money($cashInHand), 'route' => route('seller.sales.index'), 'icon' => 'ri-wallet-3-line'],
    ['title' => 'Revenue', 'value' => money($totalRevenue), 'route' => route('seller.sales.index'), 'icon' => 'ri-money-dollar-circle-line'],
    ['title' => 'Due', 'value' => money($due), 'route' => route('seller.sales.index'), 'icon' => 'ri-error-warning-line'],
    ['title' => 'Products', 'value' => $totalProducts, 'route' => route('seller.products.index'), 'icon' => 'ri-box-3-line'],
    ['title' => 'Customers', 'value' => $totalCustomers, 'route' => route('seller.customers.index'), 'icon' => 'ri-team-line'],
];
@endphp
...
<div class="card mt-6">
    <div class="card-header">
        ...
        <a href="{{ route('seller.sales.index') }}" class="btn btn-sm btn-secondary">
            ...
            <tbody>
                @forelse($recentOrders as $order)
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{ route('seller.sales.invoice', $order->order_id) }}" class="btn btn-primary btn-sm" title="Invoice" target="_blank">
