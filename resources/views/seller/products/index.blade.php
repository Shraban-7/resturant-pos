...
<div class="page-header">
    ...
    <div class="page-actions">
        <a class="btn btn-primary" href="{{ route('seller.products.create') }}">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="inline-flex items-center gap-1">
                                <a href="{{ route('seller.products.recipe.edit', $product) }}" class="btn btn-secondary btn-sm" title="Recipe BOM">
                ...
                @empty
                    <tr><td colspan="6">
                        <div class="empty-state">
                            ...
                            <a href="{{ route('seller.products.create') }}" class="btn btn-primary mt-4">
                                <i class="ri-add-line"></i> Add Product
                            </a>
                        </div>
                    </td></tr>
