                ...
                @forelse ($branches as $branch)
                    <tr>
                        ...
                        <td class="text-right space-x-1">
                            <form action="{{ route('seller.branches.switch') }}" method="post" class="inline">
                                @csrf
                            ...
                            <form action="{{ route('seller.branches.destroy', $branch) }}" method="post" class="inline"
...
<div x-data="{ open: false }"
    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-lg p-5" @click.outside="open = false">
        ...
        <form method="post" action="{{ route('seller.branches.store') }}" class="space-y-3">
            @csrf
            <div>
