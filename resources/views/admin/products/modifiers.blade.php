...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <tbody>
                    @forelse ($product->productModifiers as $pm)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.products.modifiers.update', [$product, $pm]) }}" method="post" class="inline">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td class="text-right">
                                <form action="{{ route('admin.products.modifiers.destroy', [$product, $pm]) }}" method="post" class="inline"
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @else
                <form action="{{ route('admin.products.modifiers.store', $product) }}" method="post" class="space-y-3">
                    @csrf
        ...
        <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display:none">
            ...
            <div class="modal-dialog modal-sm relative">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.products.modifiers.store', $product) }}" method="post">
                        @csrf
